...
export default function GreetCard(props) {
    ...
    return(
        <div className='group flex justify-between m-3 w-[300px] h-[100px] rounded bg-[#353535]/50 hover:bg-[#3a3a3a]'>
            ...
            <span className='relative invisible group-hover:visible shadow-lg mt-[28px] mr-[15px] pt-[10px] w-[50px] h-[50px] hover:w-[52px] hover:h-[52px] bg-[#1ed760] text-center rounded rounded-full'>
