...
export default function RadioCard(props) {
    ...
    return(
        <div className='group grid m-2 p-3 w-[210px] h-[280px] rounded bg-[#252525] hover:bg-[#3a3a3a]'>
            ...
            <span className='relative invisible group-hover:visible shadow-lg mt-[-130px] ml-[130px] pt-[10px] w-[50px] h-[50px] hover:w-[52px] hover:h-[52px] bg-[#1ed760] text-center rounded rounded-full'>
